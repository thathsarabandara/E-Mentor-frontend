          ...
          <div className='flex flex-col justify-between items-start h-48 w-96 p-3 bg-white border-2 border-gray-300 hover:bg-orange-50'>
            <div className='flex flex-col justify-between items-start'>
              <div className='flex justify-between items-center mb-4'>
                <div className={`flex border-2 w-36 h-7 overflow-hidden mr-16 bg-${course.color}-200 justify-center items-center`} >
              ...
              <div className='flex justify-center items-center my-3 pt-3'>
                <div className='flex justify-center items-center'>
                    <a href={`${course.instructorLink}`} className=' flex justify-center items-center hover:text-orange-600'>
                        ...
                        <p className='text-sm mx-2 text-gray-400 hover:text-black'>{course.instructorName}</p>
                    </a>
                </div>
            ...
            <div className='flex justify-center items-center mr-4 pt-3 border-t-2'>
              <div className='flex justify-center items-center'>
