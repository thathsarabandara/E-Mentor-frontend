  ...
  return (
    <div className='flex flex-col justify-start items-center font-inter min-h-screen'>
        <div className="flex flex-col justify-center items-start bg-gray-200 w-full">
            <div className="flex flex-col justify-center items-center mx-10 w-10/12 mt-6 py-8 md:w-9/12 lg:w-8/12 xl:w-7/12">
                <div className="flex flex-col justify-center items-start">
                    ...
                    <div className="flex flex-col md:flex-row justify-between items-center mt-5 space-x-0 md:space-x-20">
                        <div className="flex justify-center items-center mb-5 md:mb-0">
                        <div className="w-12 overflow-hidden rounded-full">
                            <img className="transform transition duration-300 ease-in-out hover:scale-125" src={instructor} alt="instructor" />
                        </div>
                        <div className="flex flex-col justify-center items-start ml-5">
                            <p className="text-xs mb-1 text-gray-700">Course by</p>
                            <p className="text-xs font-bold">Kristin Watson</p>
                        </div>
                        </div>
        ...
        <div className='flex flex-col xl:flex-row justify-center items-center xl:items-start pt-12 w-full xl:w-10/12'>
            <div className='flex flex-col justify-center items-center w-full px-4'>
                ...
                <ul className='flex justify-between items-center mt-4 w-full py-2 px-6 border-b-2'>
                    <li>
                ...
                <section id='overview' className='w-full mt-4'>
                    <div className='flex flex-col justify-center items-start w-full'>
                    <div className='flex flex-col justify-center items-start w-full'>
                        <p className='text-lg font-bold'>Description</p>
                        <p className='text-xs text-gray-500'>
                        It gives you a huge self-satisfaction when you look at your work and say, 
                        "I made this!". I love that feeling after I'm done working on something. 
                        When I lean back in my chair, look at the final result with a smile, and 
                        have this little "spark joy" moment. It's especially satisfying when I know 
                        I just made $5,000.

                        I do! And that's why I got into this field. 
                        Not for the love of Web Design, which I do now. But for the LIFESTYLE! There
                         are many ways one can achieve this lifestyle. This is my way. This is how I
                          achieved a lifestyle I've been fantasizing about for five years. And I'm 
                          going to teach you the same. Often people think Web Design is complicated. 
                          That it needs some creative talent or knack for computers. Sure, a lot of 
                          people make it very complicated. People make the simplest things complicated.
                           Like most subjects taught in the universities. But I don't like complicated. 
                           I like easy. I like life hacks. I like to take the shortest and simplest 
                           route to my destination. I haven't gone to an art school or have a computer 
                           science degree. I'm an outsider to this field who hacked himself into it, 
                           somehow ending up being a sought-after professional. That's how I'm going to 
                           teach you Web Design. So you're not demotivated on your way with needless 
                           complexity. So you enjoy the process because it's simple and fun. So you can 
                           become a Freelance Web Designer in no time.

                        For example, this is a Design course but I don't teach you Photoshop. Because 
                        Photoshop is needlessly complicated for Web Design. But people still teach it 
                        to web designers. I don't. I teach Figma – a simple tool that is taking over 
                        the design world. You will be designing a complete website within a week while 
                        others are still learning how to create basic layouts in Photoshop.

                        Second, this is a Development course. But I don't teach you how to code. 
                        Because for Web Design coding is needlessly complicated and takes too long to 
                        learn. Instead, I teach Webflow – a tool that is taking over the web design 
                        world. You will be building complex websites within two weeks while others are 
                        still learning the basics of HTML & CSS. Third, this is a Freelancing course. 
                        But I don't just teach you how to write great proposals. I give you a winning 
                        proposal template. When you're done with the course, you will have a stunning 
                        portfolio website with portfolio pieces already in it. Buy this course now and 
                        take it whenever the time is right for you.
                        </p>
                    </div>

                    <div className='flex flex-col justify-start items-start bg-green-200 w-full my-4'>
                        <p className='px-8 py-5 text-lg font-bold'>What you will learn in this course</p>
                        <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                            ...
                            <div className='flex justify-center items-start pl-8 pb-5'>
                                ...
                                <p className='text-xs text-gray-700 w-11/12'>
                                    You will learn how to design beautiful websites using Figma, an interface 
                                    design tool used by designers at Uber, Airbnb and Microsoft.
                                </p>
                            </div>
                ...
                <section id='curriculum' className='w-full'>
                    ...
                    <div className='flex justify-between items-center w-full'>
                        <div className='flex justify-start items-center w-full'>
                            <p className='px-8 py-5 text-lg font-bold'>Curriculum</p>
                        </div>
                        <div className='flex justify-center items-center w-full hidden sm:flex'>
                            <div className='flex justify-center items-center text-sm mr-3'>
                                ...
                                <p className='ml-2 text-gray-600'>6 Sections</p>
                            </div>
                            <div className='flex justify-center items-center text-sm mr-3'>
                                <PiVideo className='text-purple-500' />
                                <p className='ml-2 text-gray-600'>202 lectures</p>
                            </div>
                            <div className='flex justify-center items-center text-sm mr-3'>
                                <CiClock2 className='text-orange-500' />
                                <p className='ml-2 text-gray-600'>19h 37m</p>
                            </div>
                        </div>
                    </div>
                    <div className='grid grid-cols-1 gap-4 w-full'>
                        <CourseSubSectionDropdown />
                        <CourseSubSectionDropdown />
                    </div>
                    </div>
                </section>
                ...
                <section id='instructor'>
                    <div className='flex flex-col justify-start items-start w-full mt-4'>
                        <p className='px-8 py-5 text-lg font-bold'>Course Instructor</p>
            ...
            <div className='w-11/12 2xl:w-3/12 px-6 border py-5 font-inter'>
                <div className='flex flex-col justify-center items-center w-full'>
                    <div className='flex justify-between items-center w-full'>
                        <p className=''>
                            $14.00
                ...
                <hr className='w-full h-1' />
                <div className='flex flex-col justify-center items-start w-11/12 sm:w-full my-3'>
                    <p className='text-black font-bold'>
                        Share this course:
                    </p>
                    <div className='flex justify-center items-center mt-2 mx-1 sm:mx-2'>
